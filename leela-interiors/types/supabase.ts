  ...
  public: {
    Tables: {
      ...
      costings: {
        ...
        Relationships: [
          {
            foreignKeyName: "costings_client_id_fkey"
            columns: ["client_id"]
            isOneToOne: false
      ...
      invoices: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "invoices_costing_id_fkey"
            columns: ["costing_id"]
            isOneToOne: false
...
export type CostingStatus = "draft" | "saved"
export type InvoiceStatus = "pending" | "partial" | "paid"
export type PaymentStage = "advance" | "pre_delivery" | "completion"
